...
--
-- Máy chủ: 127.0.0.1
-- Thời gian đã tạo: Th10 02, 2024 lúc 02:51 PM
...
ALTER TABLE user 
MODIFY image VARCHAR(255) DEFAULT 'male.jpg',
MODIFY birthday DATE DEFAULT '2000-01-01',
MODIFY country VARCHAR(50) DEFAULT 'Việt Nam',
MODIFY phone VARCHAR(15) DEFAULT '090';

DELIMITER //

CREATE TRIGGER set_default_bio
